...
public class LoginStatusActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(LoginStatusActivity.this,"Verification link sent to "+ FirebaseAuth.getInstance().getCurrentUser().getEmail(),Toast.LENGTH_SHORT).show();
    ...
    private void sendToMain() {
        Intent mainIntent = new Intent(LoginStatusActivity.this,  com.thenetwork.app.android.thenetwork.Activities.MainActivity.class);
