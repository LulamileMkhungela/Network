...
import com.thenetwork.app.android.thenetwork.SendFeedBack;
import com.thenetwork.app.android.thenetwork.Settings;
...
public class MainActivity extends AppCompatActivity {
    ...
    String home,requests,chats,title;
...
//        mainToolbar = (Toolbar) findViewById(R.id.tool);
        //mainToolbar.setTitleTextAppearance(this, R.style.TitleBarTextAppearance);
        //setSupportActionBar(mainToolbar);
        getSupportActionBar().setTitle("TheNetwork");
...
//            eventsFragment = new EventsFragment();
                ...
                public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        Glide.with(MainActivity.this).load(image)
                                .apply(new RequestOptions().dontTransform().dontAnimate().placeholder(R.drawable.default_profile))
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (id) {
                        ...
                        case R.id.action_account:
                            sendToViewProfile("Profile", mAuth.getCurrentUser().getUid());
                            return true;
                        case R.id.action_followers:
                            sendToFollow("Followers", mAuth.getCurrentUser().getUid());
                            return true;
                        case R.id.action_settings:
                            sendToSettings("Settings", mAuth.getCurrentUser().getUid());
                            return true;
                        case R.id.action_feedback:
                            sendToFeedback("Send Feedback", mAuth.getCurrentUser().getUid());
                            return true;
                        case R.id.action_faqs:
                            sendToFaqs("FAQS", mAuth.getCurrentUser().getUid());
                            return true;
    ...
    private void sendToFeedback(String send_feedback, String uid) {
...
//        intent.putExtra("whichUser", userid);
    ...
    private void sendToFaqs(String faqs, String uid) {
        Intent intent = new Intent(MainActivity.this, FaqsClass.class);
//        intent.putExtra("title", data);
//        intent.putExtra("whichUser", userid);
        startActivity(intent);
    }

    private void sendToSettings(String settings, String uid) {
...
//        intent.putExtra("whichUser", userid);
    ...
    protected void onStart() {
        ...
        if (currentUser == null) {
            ...
            if (!currentUser.isEmailVerified()) {
                Toast.makeText(MainActivity.this, "Opps, Your Email is not verified", Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            if (!task.getResult().exists()) {
                                ...
                                Intent setupIntent = new Intent(MainActivity.this, com.thenetwork.app.android.thenetwork.Activities.SetupActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_account:
                Intent accountIntent = new Intent(MainActivity.this, com.thenetwork.app.android.thenetwork.Activities.ProfileActivity.class);
                accountIntent.putExtra("user_id", current_user_id);
                startActivity(accountIntent);
                return true;

//            case R.id.action_tips:
//                Intent Intent = new Intent(MainActivity.this, com.thenetwork.app.android.thenetwork.Activities.SafetyDialogActivity.class);
...
//                return true;
    ...
    private void sendToLogin() {
        Intent intent = new Intent(MainActivity.this, com.thenetwork.app.android.thenetwork.Activities.SplashActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
    }
...
//            fragmentTransaction.hide(eventsFragment);
    ...
    private void sendToViewProfile(String data, String userid) {
