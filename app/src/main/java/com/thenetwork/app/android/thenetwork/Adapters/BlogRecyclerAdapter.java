...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.BlogViewHolder>
    ...
    public BlogViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewMore = view.findViewById(R.id.blog_comment_btn);
            ...
            likeCollectionRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                    ...
                    if (documentSnapshots.isEmpty()) {
                        holder.blogLikeCount.setText(0 + " ");
                    } else {
                        int likeCount = documentSnapshots.size();
                        holder.blogLikeCount.setText(likeCount + " ");
                    }
                }
            });
            ...
            likeReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                ...
                public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        holder.blogLikeBtn.setImageDrawable(context.getDrawable(R.drawable.ic_like_btn));
                    }
                }
            });
 ...
 private void loadMessages(String mBlogId){
        ...
        Log.i("chatActivityCount","Woohoo! Loading messages");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    if (task.getResult().getDocuments().isEmpty()){
                        mDialog.dismiss();
                        Toast.makeText(context,"No comments,be the first one to comment",Toast.LENGTH_SHORT).show();
                    }
    ...
    private void loadMoreMessages(String mBlogId){
        Query nextQuery = firebaseFirestore.collection("Posts").document(mBlogId)
                .collection("Comments").orderBy("timestamp", Query.Direction.DESCENDING).startAfter(lastVisible).limit(250);
