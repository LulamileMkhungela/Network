...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotificationFollow(String messageTitle,String messageBody, Context context
        ...
        if (click_action.equals("com.thefindnetwork.app.android.network.Activities.ONFOLLOWREQUESTRECEIVED")){
            resultIntent.putExtra("user_id",dataFrom);
        } else if (click_action.equals("com.thefindnetwork.app.android.network.Activities.ONNEWMESSAGERECEIVED")){
            resultIntent.putExtra("user_id",dataFrom);
