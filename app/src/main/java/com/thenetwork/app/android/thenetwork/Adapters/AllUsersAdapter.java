...
public class AllUsersAdapter extends RecyclerView.Adapter<AllUsersAdapter.UsersViewHolder> {
    ...
    public class UsersViewHolder extends RecyclerView.ViewHolder {
        ...
        public UsersViewHolder(View itemView) {
            ...
            userName = itemView.findViewById(R.id.AlluserSingleName);
            userStatus = itemView.findViewById(R.id.AlluserSingleStatus);
            userImage = itemView.findViewById(R.id.AlluserSingleImage);
